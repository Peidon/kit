...
func valuatelexerLexerInit() {
	...
	staticData.ruleNames = []string{
		"T__0", "T__1", "TRUE", "FALSE", "NIL_LIT", "LP", "RP", "L_CURLY", "R_CURLY",
		"L_BRACKET", "R_BRACKET", "COMMA", "DOT", "LOGICAL_OR", "LOGICAL_AND",
		"EQUALS", "NOT_EQUALS", "LESS", "LESS_OR_EQUALS", "GREATER", "GREATER_OR_EQUALS",
		"DIV", "PLUS", "MINUS", "STAR", "MODULUS", "SKIP_", "WHITESPACE", "IDENTIFIER",
		"VAR_ID", "STRING", "STRING_LITERAL", "BYTES_LITERAL", "DECIMAL_LIT",
	...
	staticData.serializedATN = []int32{
		...
		7, 57, 2, 58, 7, 58, 1, 0, 1, 0, 1, 1, 1, 1, 1, 2, 1, 2, 1, 2, 1, 2, 1,
		...
		0, 0, 7, 128, 1, 0, 0, 0, 9, 134, 1, 0, 0, 0, 11, 138, 1, 0, 0, 0, 13,
		140, 1, 0, 0, 0, 15, 142, 1, 0, 0, 0, 17, 144, 1, 0, 0, 0, 19, 146, 1,
		0, 0, 0, 21, 148, 1, 0, 0, 0, 23, 150, 1, 0, 0, 0, 25, 152, 1, 0, 0, 0,
		27, 154, 1, 0, 0, 0, 29, 157, 1, 0, 0, 0, 31, 160, 1, 0, 0, 0, 33, 163,
		1, 0, 0, 0, 35, 166, 1, 0, 0, 0, 37, 168, 1, 0, 0, 0, 39, 171, 1, 0, 0,
		0, 41, 173, 1, 0, 0, 0, 43, 176, 1, 0, 0, 0, 45, 178, 1, 0, 0, 0, 47, 180,
		...
		0, 0, 117, 400, 1, 0, 0, 0, 119, 120, 5, 33, 0, 0, 120, 2, 1, 0, 0, 0,
		121, 122, 5, 48, 0, 0, 122, 4, 1, 0, 0, 0, 123, 124, 5, 116, 0, 0, 124,
		125, 5, 114, 0, 0, 125, 126, 5, 117, 0, 0, 126, 127, 5, 101, 0, 0, 127,
		6, 1, 0, 0, 0, 128, 129, 5, 102, 0, 0, 129, 130, 5, 97, 0, 0, 130, 131,
		5, 108, 0, 0, 131, 132, 5, 115, 0, 0, 132, 133, 5, 101, 0, 0, 133, 8, 1,
		0, 0, 0, 134, 135, 5, 110, 0, 0, 135, 136, 5, 105, 0, 0, 136, 137, 5, 108,
		0, 0, 137, 10, 1, 0, 0, 0, 138, 139, 5, 40, 0, 0, 139, 12, 1, 0, 0, 0,
		140, 141, 5, 41, 0, 0, 141, 14, 1, 0, 0, 0, 142, 143, 5, 123, 0, 0, 143,
		16, 1, 0, 0, 0, 144, 145, 5, 125, 0, 0, 145, 18, 1, 0, 0, 0, 146, 147,
		5, 91, 0, 0, 147, 20, 1, 0, 0, 0, 148, 149, 5, 93, 0, 0, 149, 22, 1, 0,
		0, 0, 150, 151, 5, 44, 0, 0, 151, 24, 1, 0, 0, 0, 152, 153, 5, 46, 0, 0,
		153, 26, 1, 0, 0, 0, 154, 155, 5, 124, 0, 0, 155, 156, 5, 124, 0, 0, 156,
		28, 1, 0, 0, 0, 157, 158, 5, 38, 0, 0, 158, 159, 5, 38, 0, 0, 159, 30,
		1, 0, 0, 0, 160, 161, 5, 61, 0, 0, 161, 162, 5, 61, 0, 0, 162, 32, 1, 0,
		0, 0, 163, 164, 5, 33, 0, 0, 164, 165, 5, 61, 0, 0, 165, 34, 1, 0, 0, 0,
		166, 167, 5, 60, 0, 0, 167, 36, 1, 0, 0, 0, 168, 169, 5, 60, 0, 0, 169,
		170, 5, 61, 0, 0, 170, 38, 1, 0, 0, 0, 171, 172, 5, 62, 0, 0, 172, 40,
		1, 0, 0, 0, 173, 174, 5, 62, 0, 0, 174, 175, 5, 61, 0, 0, 175, 42, 1, 0,
		0, 0, 176, 177, 5, 47, 0, 0, 177, 44, 1, 0, 0, 0, 178, 179, 5, 43, 0, 0,
		179, 46, 1, 0, 0, 0, 180, 181, 5, 45, 0, 0, 181, 48, 1, 0, 0, 0, 182, 183,
		5, 42, 0, 0, 183, 50, 1, 0, 0, 0, 184, 185, 5, 37, 0, 0, 185, 52, 1, 0,
		...
		15, 7, 0, 208, 214, 3, 57, 28, 0, 209, 210, 3, 25, 12, 0, 210, 211, 3,
		57, 28, 0, 211, 213, 1, 0, 0, 0, 212, 209, 1, 0, 0, 0, 213, 216, 1, 0,
		0, 0, 214, 212, 1, 0, 0, 0, 214, 215, 1, 0, 0, 0, 215, 217, 1, 0, 0, 0,
		216, 214, 1, 0, 0, 0, 217, 218, 3, 17, 8, 0, 218, 221, 1, 0, 0, 0, 219,
...
const (
	...
	valuateLexerTRUE              = 3
	valuateLexerFALSE             = 4
	valuateLexerNIL_LIT           = 5
	valuateLexerLP                = 6
	valuateLexerRP                = 7
	valuateLexerL_CURLY           = 8
	valuateLexerR_CURLY           = 9
	valuateLexerL_BRACKET         = 10
	valuateLexerR_BRACKET         = 11
	valuateLexerCOMMA             = 12
	valuateLexerDOT               = 13
